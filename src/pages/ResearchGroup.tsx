          ...
          <div>
            ...
            <Card className="p-8 border-border mb-8">
              ...
              <p className="text-text leading-relaxed mb-4">
                Our research group focuses on advanced materials engineering,
                computational mechanics, and aerospace applications. We work on
                cutting-edge problems in material science and mechanical
                engineering.
              </p>
              <p className="text-text leading-relaxed">
                The group consists of dedicated postdoctoral researchers and PhD
                students working on various funded projects and collaborating
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {postdocs.map((person, index) => (
                <Card
                  key={index}
                  className="p-6 border-border text-center hover:shadow-md transition-shadow"
                >
