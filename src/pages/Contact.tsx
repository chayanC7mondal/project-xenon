              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:professor@iit.ac.in"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+911234567890" className="text-text">
                      +91 (123) 456-7890
                    </a>
                  </div>
                </div>
            ...
            <Card className="p-8 border-border">
              ...
              <div className="mt-8 p-4 bg-secondary rounded-lg">
                <p className="text-sm text-text">
                  For research collaborations or academic inquiries, please send
                  an email with your detailed proposal or questions.
                </p>
              </div>
            </Card>
          </div>
